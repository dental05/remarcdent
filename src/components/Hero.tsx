      ...
      <div className="container relative z-10 mx-auto px-4 py-24">
        <div className="max-w-3xl mx-auto text-center text-primary-foreground animate-fade-up">
          ...
          <p className="mb-10 font-inter text-lg md:text-xl text-muted-foreground/90 leading-relaxed">
            Am creat un spațiu dedicat îngrijirii complete, unde tehnologia
            digitală și experiența medicală se întâlnesc pentru a oferi
            tratamente personalizate, rezultate estetice remarcabile și confort
            absolut la fiecare vizită.
          </p>
          ...
          <div className="grid gap-4 sm:grid-cols-3">
            <div className="rounded-xl border border-border/60 bg-background/70 px-5 py-4 backdrop-blur">
              ...
              <p className="mb-1 font-poppins text-sm font-semibold text-foreground">
                Tehnologie digitală
              </p>
              <p className="font-inter text-xs text-muted-foreground">
                Scanner intraoral, radiologie și imprimantă 3D pentru tratamente
                precise.
              </p>
            </div>
            <div className="rounded-xl border border-border/60 bg-background/70 px-5 py-4 backdrop-blur">
              ...
              <p className="font-inter text-xs text-muted-foreground">
                Echipe multidisciplinare care construiesc soluții adaptate
                obiectivelor tale estetice și medicale.
              </p>
            </div>
            <div className="rounded-xl border border-border/60 bg-background/70 px-5 py-4 backdrop-blur">
              ...
              <p className="font-inter text-xs text-muted-foreground">
                Mii de pacienți tratați cu succes și recomandări care ne inspiră
                să evoluăm constant.
              </p>
            </div>
          </div>

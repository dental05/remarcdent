...
const pageHighlights = [
  {
    ...
    description:
      "Află povestea cabinetului, filosofia noastră și modul în care îmbinăm tehnologia cu grija pentru pacienți.",
    to: "/despre",
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12">
            <h2 className="font-poppins text-3xl md:text-4xl font-bold text-foreground mb-4">
              Descoperă cabinetul REMARC DENT
            </h2>
            <p className="font-inter text-lg text-muted-foreground">
              Navighează prin paginile dedicate pentru a găsi rapid informațiile
              de care ai nevoie despre serviciile, echipa și programările
              noastre.
            </p>
          </div>
          ...
          <div className="grid gap-6 lg:grid-cols-12 items-stretch">
            <Card className="p-8 bg-gradient-to-br from-primary/10 via-background to-background border-0 shadow-lg animate-fade-up lg:col-span-5 flex flex-col h-full">
              <div className="flex items-center gap-3 mb-6">
                ...
                <span className="font-inter uppercase text-xs tracking-[0.3em] text-primary">
                  Experiență premium
                </span>
              </div>
              ...
              <p className="font-inter text-base text-muted-foreground leading-relaxed mb-6">
                REMARC DENT îmbină actul medical al unei echipe
                multidisciplinare cu tehnologie actuală, pentru a oferi
                tratamente personalizate, predictibile și o experiență relaxată
                la fiecare vizită.
              </p>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-auto">
                <div className="rounded-xl bg-background/70 border border-border/60 px-5 py-4">
                  ...
                  <p className="font-inter text-sm text-muted-foreground">
                    Scanner intraoral, radiologie și imprimantă 3D pentru
                ...
                <div className="rounded-xl bg-background/70 border border-border/60 px-5 py-4">
                  ...
                  <p className="font-inter text-sm text-muted-foreground">
                    Echipe dedicate pentru implantologie, ortodonție, estetică
                    și tratamente pediatric.
                  </p>
                </div>
                <div className="rounded-xl bg-background/70 border border-border/60 px-5 py-4">
                  <div className="flex items-center gap-3 mb-2">
                  ...
                  <p className="font-inter text-sm text-muted-foreground">
                    Lucrări protetice realizate in-house pentru adaptări rapide
                ...
                <div className="rounded-xl bg-background/70 border border-border/60 px-5 py-4">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <p className="font-poppins text-sm font-semibold text-foreground">
                      Spațiu prietenos și curat
                    </p>
                  </div>
                  <p className="font-inter text-sm text-muted-foreground">
                    Dotarea cu sistem HEPA de filtrare al aerului asigură un
                    mediu curat și sigur pentru pacienți și personal.
                  </p>
                </div>
              </div>
            </Card>
            ...
            <div className="grid sm:grid-cols-2 xl:grid-cols-3 gap-6 lg:col-span-7">
              {pageHighlights.map(
                ({ title, description, to, accentClasses, Icon }, index) => (
                  <Card
                    key={title}
                  ...
                  >
                    <div
                      className={`w-12 h-12 rounded-lg flex items-center justify-center mb-4 ${accentClasses}`}
                    >
            ...
            <div className="grid md:grid-cols-[2fr_1fr] gap-8 items-center">
              <div>
                ...
                <p className="font-inter text-base md:text-lg opacity-90 leading-relaxed">
                  Suntem aici să te ghidăm spre tratamentele potrivite și să-ți
                  oferim o experiență confortabilă la fiecare vizită.
                  Programează-te online sau contactează-ne pentru mai multe
                  detalii.
                </p>
              </div>
